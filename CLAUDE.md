...
- **Design docs**: `docs/spec/` is the source of truth (reverse-spec'd to code);
  `docs/reference/` holds the tool + CLI contracts. `docs/spec/how-it-works.md` is the
  how-it-works narrative; `README.md` is end-user usage.
